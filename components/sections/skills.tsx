    ...
    <SectionContainer id="skills" className="bg-transparent">
      <MotionSection>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          {/* Skill Tree Area */}
          <div className="lg:w-2/3 glass rounded-2xl p-6 md:p-10 relative overflow-hidden min-h-125">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative max-w-2xl mx-auto">
                  ...
                  <div className="absolute left-1/2 top-0 bottom-0 w-px bg-linear-to-b from-primary/50 via-primary/20 to-transparent -translate-x-1/2 hidden md:block" />
        ...
        >
          ...
          <div className="h-2 bg-muted rounded-full overflow-hidden relative z-10">
            <motion.div
              ...
              className="h-full bg-linear-to-r from-primary/60 to-primary rounded-full relative"
            />
          </div>
        </motion.div>
      </motion.div>
